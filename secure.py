...
st.markdown("""
    <style>
        /* gradient to the body */
        .stApp {
            background: linear-gradient(135deg, #dcb4f5, #ff9a8b) !important;
        ...
        /* Sidebar Background */
        .stSidebar {
            background: linear-gradient(135deg, #e0bbfc, #d8a7ca) !important;
        }

        /* Sidebar Menu Text */
        .stSidebar .css-1kyxreq > div {
            color: white;
        }
        ...
        .stTextInput input, .stTextArea textarea, .stPasswordInput input {
            color: #000;
        }
    </style>
